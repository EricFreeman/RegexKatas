...
namespace RegexKatas
{
    ...
    {
        public const string TestVar1 ="Tech Support: (801)-555-1234";
        ...
        /// <summary>
        /// Find all the phone numbers from the four test strings using the same regex.
        /// </summary>
        [Fact]
        public static void Test1()
        {
            ...
            Assert.True(m1.Success && m2.Success && m3.Success && m4.Success);
            Assert.True(m1.Groups[captureGroup].Value.Equals("(801)-555-1234"));
        ...
        /// <summary>
        /// Find the contact name for all numbers with an area code of 801
        /// </summary>
        [Fact]
        public static void Test2()
        {
            ...
            Assert.True(m1.Success && !m2.Success && m3.Success && !m4.Success);
            Assert.True(m1.Groups[captureGroup].Value.Equals("Tech Support"));
